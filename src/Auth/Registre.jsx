...
const RegisterForm = () => {
    ...
    const roles = ["Partner", "SuperAgent", "Agent", "User"]; // Updated to match backend
    ...
    const handleRegister = async () => {
        ...
        try {
            const updatedProfil = { ...profil, id: user._id }; // Pass user ID
            console.log("Registering user with profile:", updatedProfil); // Debug
        ...
        >
            ...
            > 
                <header className="text-center mb-6">
                    ...
                    <p className="text-gray-500">Create a new account by filling in the details below.</p>
                </header>
